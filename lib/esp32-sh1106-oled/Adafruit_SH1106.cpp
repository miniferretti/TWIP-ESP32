...
Adafruit_SH1106::Adafruit_SH1106(uint8_t reset) : Adafruit_GFX(SH1106_LCDWIDTH, SH1106_LCDHEIGHT)
{
  sclk = dc = cs = sid = -1;
  rst = reset;
}

Adafruit_SH1106::Adafruit_SH1106(int8_t SDA, int8_t SCL) : Adafruit_GFX(SH1106_LCDWIDTH, SH1106_LCDHEIGHT)
{
  sclk = dc = cs = sid = -1;
  sda = SDA;
  scl = SCL;
